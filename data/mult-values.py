...
def parse_args(pargs=None):
    ...
    parser.add_argument('--data0', default='./cac40.csv',
                        required=False, help='Data0 to read in')

    parser.add_argument('--data1', default='./TOTAL.csv',
                        required=False, help='Data1 to read in')

    parser.add_argument('--data2', default='./apple.csv',
                        required=False, help='Data1 to read in')
    ...
    parser.add_argument('--todate', required=False, default='2017-10-01',
                        help='Date[time] in YYYY-MM-DD[THH:MM:SS] format')
